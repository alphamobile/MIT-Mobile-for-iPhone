...
- (void)setupLeftButton
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"H:|-%f-[leftButton(==%f)]->=0-|", kBottomButtonPadding, kBottomButtonSize] options:0 metrics:nil views:viewsDictionary]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"V:|->=0-[leftButton(==%f)]-%f-|", kBottomButtonSize, kBottomButtonPadding] options:0 metrics:nil views:viewsDictionary]];
}
...
- (void)setupRightButton
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"H:|->=0-[rightButton(==%f)]-%f-|", kBottomButtonSize, kBottomButtonPadding] options:0 metrics:nil views:viewsDictionary]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"V:|->=0-[rightButton(==%f)]-%f-|", kBottomButtonSize, kBottomButtonPadding] options:0 metrics:nil views:viewsDictionary]];
}
